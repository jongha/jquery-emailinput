...
a.substr(a.length-1,1)&&(a=a.substr(0,a.length-1));return a},createAddressBox:function(a){var b=a.text;if(""!==b){var c=!a.validation?this.validation(a.value):a.validation,d=document.createElement("li");d.className="blass_eai_box "+(c?"blass_eai_valid":"blass_eai_invalid");d.id=this._getAddressBoxId();d.objValue=a.value;d.isValid=c;a=document.createElement("span");a.className="blass_eai_address";a.innerHTML=b;d.appendChild(a);b=document.createElement("span");b.className="blass_eai_delete";d.appendChild(b);
b.blass=this;b.onclick=function(){this.blass._removeAddressBox(this.parentNode.id)};this._addressBoxUl.insertBefore(d,this._addressBoxList[0]);this._addressBoxList.push(d)}},_createCSS:function(){if(!this._existCSS){var a=document.createElement("style"),b=".blass_eai_ac { border: solid 1px #cccccc; width: 500px; visibility: hidden; position: absolute; background-color:#ffffff; padding: 5px; z-index: 1000; font-size:"+this._inputStyle.fontSize+"; }",b=b+".blass_eai_aclayer { padding: 0px 0px 3px 0px; cursor:pointer }.blass_eai_select { font-weight: bold; }",
b=b+".blass_eai_normal { font-weight: normal; }",c=!1;if("Microsoft Internet Explorer"===navigator.appName){var d=navigator.userAgent;6>=parseInt(d.substring(d.indexOf("MSIE ")+5),null)&&(c=!0,b+=".blass_eai_inputdiv { height: 22px; padding:1px; cursor:text; border:"+this._inputStyle.border+"; }")}c||(b+=".blass_eai_inputdiv { max-height: 46px; overflow-y: auto; padding:1px; cursor:text; border:"+this._inputStyle.border+"; }");b+=".blass_eai_li { margin-left:6px; }";b+=".blass_eai_ul { list-style-type:none; margin:0px; padding:0px; }";
b+=".blass_eai_input { outline:none; width:50px; height: 18px; margin-top: 3px; padding:0px 0px 0px 3px; border:0px solid #ffffff; overflow:hidden; float:left; }";b+=".blass_eai_box { display:block; height: 14px; margin:1px; padding:2px 7px; width:auto; float:left; }";b+=".blass_eai_ruler { position: absolute; overflow:hidden; visibility:hidden; z-index:-1; }";b+=".blass_eai_valid { border:1px solid #bbd8fb; background-color:#f3f7fd; }";b+=".blass_eai_invalid { border:1px solid #b55e5e; background-color:#fdf5f5; }";
b+=".blass_eai_delete { cursor:pointer; margin:2px 0px 0px 5px; float:left; width:9px; height:9px; }";b+=".blass_eai_valid .blass_eai_delete { background:url(data:image/gif;base64,R0lGODlhCQAJAKIAAJu226O83pOx15u32////////wAAAAAAACH5BAEAAAUALAAAAAAJAAkAAAMaGLo6ATAC8Ui0FFo7n44ZsEEZJ3YSOAhsyyYAOw==) no-repeat; }";b+=".blass_eai_invalid .blass_eai_delete { background:url(data:image/gif;base64,R0lGODlhCQAJAKIAALukpaqQkrSanKKGif708v///wAAAAAAACH5BAEAAAUALAAAAAAJAAkAAAMaCLoqEDCG8Ui0FFo7n45ZsEEZJ3YSOKwsmwAAOw==) no-repeat; }";
